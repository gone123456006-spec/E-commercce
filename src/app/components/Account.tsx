              ...
              <div className="flex items-center justify-between mb-4 md:mb-6">
                ...
                {!isEditing && hasProfile() && (
                  <button
                    ...
                    className="px-3 md:px-4 py-1.5 md:py-2 text-sm md:text-base text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors"
                  >
                    Edit
                  </button>
                )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg md:rounded-xl shadow-md p-4 md:p-6 space-y-3 md:space-y-4">
              ...
              <button
                ...
                className="w-full px-4 md:px-6 py-2.5 md:py-3 text-sm md:text-base border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors text-left flex items-center gap-2 md:gap-3"
              >
