    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-8">
        ...
        <div className="flex items-center gap-2 text-sm md:text-base text-gray-600 mb-4 md:mb-6 overflow-x-auto">
          ...
          <span>/</span>
          <Link to={`/category/${product.category}`} className="hover:text-blue-600 capitalize whitespace-nowrap">
            {product.category}
          </Link>
          <span>/</span>
        ...
        <div className="bg-white rounded-xl md:rounded-2xl shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 p-4 md:p-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-2xl md:text-3xl lg:text-4xl text-blue-600 mb-4 md:mb-6">
                ₹{product.price}
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mt-auto">
                <button
                  ...
                  className="flex-1 px-4 md:px-6 py-3 md:py-4 border-2 border-blue-600 text-blue-600 rounded-lg md:rounded-xl hover:bg-blue-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-base md:text-lg flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  disabled={product.stock === 0}
                  className="flex-1 px-4 md:px-6 py-3 md:py-4 bg-blue-600 text-white rounded-lg md:rounded-xl hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-base md:text-lg"
                >
                  Buy Now
                </button>
              </div>
